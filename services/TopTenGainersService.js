  ...
  if (data.length > 0) {
    for (let i = 0; i < data.length; i++) {
      ...
      const coinInfo = {
        ...
        priceChange24H: coin.price_change_percentage_24h ? coin.price_change_percentage_24h : 0.00,
      };
      top10CoinsInfo.push(coinInfo);
    }
  }
  console.log(top10CoinsInfo);
