      ...
      <ScrollView
        ...
        <View style={styles.container}>
          ...
          Last updated January 16, 2024
            {'\n\n'}
            AI Alpha is licensed to You (End-User) by Novatide Limited, located and registered at
71-75 Shelton Street, Covent Garden, London, London WC2H
9JQ, England ('Licensor'), for use only under the terms of this Licence Agreement.
{'\n\n'}
By downloading the Licensed Application from Apple's software distribution platform
('App Store'), and any update thereto (as permitted by this Licence Agreement), You
indicate that You agree to be bound by all of the terms and conditions of this Licence
Agreement, and that You accept this Licence Agreement. App Store is referred to in
this Licence Agreement as 'Services'.
{'\n\n'}
The parties of this Licence Agreement acknowledge that the Services are not a Party
to this Licence Agreement and are not bound by any provisions or obligations with
regard to the Licensed Application, such as warranty, liability, maintenance and
support thereof. Novatide Limited, not the Services, is solely responsible for the
Licensed Application and the content thereof.
{'\n\n'}
This Licence Agreement may not provide for usage rules for the Licensed Application
that are in conflict with the latest Apple Media Services Terms and Conditions
('Usage Rules'). Novatide Limited acknowledges that it had the opportunity to review
the Usage Rules and this Licence Agreement is not conflicting with them.
{'\n\n'}
AI Alpha when purchased or downloaded through the Services, is licensed to You for
use only under the terms of this Licence Agreement. The Licensor reserves all rights
not expressly granted to You. AI Alpha is to be used on devices that operate with
...
{'\n\n'}
AI Alpha ('Licensed Application') is a piece of software created to educating our
users with our first of its kind AI crypto educational assistant on the digital finance
markets — and customised for iOS mobile devices ('Devices'). It is used to Allow
users access to key information to help enhance their understanding of digital finance
markets.
{'\n\n'}
...
Security Management Act (FISMA), etc.), so if your interactions would be subjected to such laws, you may not use this Licensed Application. You may not use the
...
{'\n\n'}
2.1 You are given a non-transferable, non-exclusive, non-sublicensable licence to
...
Application may be accessed and used by other accounts associated with You (End-
User, The Purchaser) via Family Sharing or volume purchasing.
{'\n\n'}
2.2 This licence will also govern any updates of the Licensed Application provided by
Licensor that replace, repair, and/or supplement the first Licensed Application, unless
a separate licence is provided for such update, in which case the terms of that new
licence will govern.
{'\n\n'}
2.3 You may not share or make the Licensed Application available to third parties
(unless to the degree allowed by the Usage Rules, and with Novatide Limited's prior
...
Novatide Limited's prior written consent).
{'\n\n'}
2.5 You may not copy (excluding when expressly authorised by this licence and the
...
the terms of this licence, the Usage Rules, and any other terms and conditions that
apply to the device or software used. You may not remove any intellectual property
notices. You acknowledge that no unauthorised third parties may gain access to
...
{'\n\n'}
2.8 Nothing in this licence should be interpreted to restrict third-party terms. When
...
{'\n\n'}
4.1 Novatide Limited is not obligated, expressed or implied, to provide any
maintenance, technical or other support for the Licensed Application.
{'\n\n'}
4.2 Novatide Limited and the End-User acknowledge that the Services have no
...
of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy, which can be accessed by Clicking on the Account
icon, and then clicking the ‘Privacy Policy'.
{'\n\n'}
...
{'\n\n'}
<Text style={styles.boldSection}>6. USER-GENERATED CONTRIBUTIONS</Text>
{'\n\n'}
...
Application Privacy Policy. When you create or make available any Contributions, you
...
in any manner contemplated by the Licensed Application and this Licence
Agreement.
{'\n\n'}
...
{'\n\n'}
Any use of the Licensed Application in violation of the foregoing violates this Licence
...
(including settings).
{'\n\n'}
By submitting suggestions of other feedback regarding the Licensed Application, you
...
all of your Contributions and any intellectual property rights or other proprietary rights associated with your Contributions. We are not liable for any statements or
...
{'\n\n'}
8.1 Licensor takes no accountability or responsibility for any damages caused due to
a breach of duties according to Section 2 of this Licence Agreement. To avoid data
...
device, that has been unauthorisedly modified, handled inappropriately or culpably,
...
any other reasons outside of Novatide Limited's sphere of influence that affect the
...
and notify Novatide Limited about issues discovered without delay by email provided
in Contact Information. The defect report will be taken into consideration and further
investigated if it has been emailed within a period of __________ days after
discovery.
{'\n\n'}
9.4 If we confirm that the Licensed Application is defective, Novatide Limited
...
{'\n\n'}
Novatide Limited and the End-User acknowledge that Novatide Limited, and not the
...
{'\n\n'}
The licence is valid until terminated by Novatide Limited or by You. Your rights under
this licence will terminate automatically and without notice from Novatide Limited if
You fail to adhere to any term(s) of this licence. Upon Licence termination, You shall
stop all use of the Licensed Application, and destroy all copies, full or partial, of the
Licensed Application.
{'\n\n'}
<Text style={styles.boldSection}>14. THIRD-PARTY TERMS OF AGREEMENTS AND
BENEFICIARY</Text>
{'\n\n'}
Novatide Limited represents and warrants that Novatide Limited will comply with
...
End-User Licence Agreement', Apple's subsidiaries shall be third-party beneficiaries
of this End User Licence Agreement and — upon Your acceptance of the terms and
conditions of this Licence Agreement, Apple will have the right (and will be deemed to
have accepted the right) to enforce this End User Licence Agreement against You as
a third-party beneficiary thereof.
{'\n\n'}
<Text style={styles.boldSection}>15. INTELLECTUAL PROPERTY RIGHTS</Text>
{'\n\n'}
Novatide Limited and the End-User acknowledge that, in the event of any third-party
...
Novatide Limited, and not the Services, will be solely responsible for the
...
{'\n\n'}
This Licence Agreement is governed by the laws of England and Wales, English law,
