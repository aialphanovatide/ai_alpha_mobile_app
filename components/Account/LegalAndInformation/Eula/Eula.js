        ...
        <ScrollView
          ...
          <View style={styles.container}>
            <Text style={styles.privacyPolicyText}>
              ...
              {'\n\n'}
              AI Alpha is licensed to You (End-User) by Novatide Limited,
              located and registered at 71-75 Shelton Street, Covent Garden,
              London, London WC2H 9JQ, England ('Licensor'), for use only under
              ...
              permitted by this Licence Agreement), You indicate that You agree
              to be bound by all of the terms and conditions of this Licence
              Agreement, and that You accept this Licence Agreement. App Store
              is referred to in this Licence Agreement as 'Services'.
              {'\n\n'}
              ...
              thereof. Novatide Limited, not the Services, is solely responsible
              ...
              Limited acknowledges that it had the opportunity to review the
              ...
              to You. AI Alpha is to be used on devices that operate with
              ...
              {'\n\n'}
              AI Alpha ('Licensed Application') is a piece of software created
              to educating our users with our first of its kind AI crypto
              educational assistant on the digital finance markets — and
              customised for iOS mobile devices ('Devices'). It is used to Allow
              users access to key information to help enhance their
              understanding of digital finance markets.
              {'\n\n'}
              ...
              and with Novatide Limited's prior written consent), sell, rent,
              ...
              unauthorised third parties may gain access to these copies at any
              ...
              {'\n\n'}
              4.2 Novatide Limited and the End-User acknowledge that the
              ...
              Licensor's privacy policy, which can be accessed by Clicking on
              the Account icon, and then clicking the ‘Privacy Policy'.
              {'\n\n'}
              ...
              parties, or if there are any other reasons outside of Novatide
              Limited's sphere of influence that affect the executability of the
              Licensed Application.
              {'\n\n'}
              9.3 You are required to inspect the Licensed Application
              immediately after installing it and notify Novatide Limited about
              ...
              and further investigated if it has been emailed within a period of
              __________ days after discovery.
              {'\n\n'}
              9.4 If we confirm that the Licensed Application is defective,
              Novatide Limited reserves a choice to remedy the situation either
              ...
              {'\n\n'}
              Novatide Limited and the End-User acknowledge that Novatide
              Limited, and not the Services, is responsible for addressing any
              ...
              {'\n\n'}
              The licence is valid until terminated by Novatide Limited or by
              You. Your rights under this licence will terminate automatically
              and without notice from Novatide Limited if You fail to adhere to
              any term(s) of this licence. Upon Licence termination, You shall
              ...
              {'\n\n'}
              Novatide Limited represents and warrants that Novatide Limited
              ...
              {'\n\n'}
              Novatide Limited and the End-User acknowledge that, in the event
              ...
              Novatide Limited, and not the Services, will be solely responsible
              for the investigation, defence, settlement, and discharge or any
              such intellectual property infringement claims.
              {'\n\n'}
              <Text style={styles.boldSection}>16. APPLICABLE LAW</Text>
              {'\n\n'}
              This Licence Agreement is governed by the laws of England and
              Wales, English law, excluding its conflicts of law rules.
              {'\n\n'}
