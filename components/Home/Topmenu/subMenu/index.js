...
const SubMenu = () => {
    ...
    const [activeSubCoin, setActiveSubCoin] = useState(activeCoin.subMenuOptions && activeCoin.subMenuOptions[0].coin)

    const coinToShowInChart = activeCoin.subMenuOptions === null ? activeCoin.icon : activeSubCoin
